...
public class ControllerGrammar implements ActionListener {

	private Grammar grammar;
	private MainWindow mainWindow;

	public ControllerGrammar() {
		...
		try {
			...
			e.printStackTrace();
			System.err.println("The ControllerGrammar class could not be instantiated.");
		}
	}
